...
class pamsimas_pmu_report(osv.osv_memory):
    ...
    def onchange_get_office(self, cr, uid, ids, position, context=None):
        ...
        if position == "roms":
            domain = [('province','=',False),('city','=',False)]
    ...
    _name = "pamsimas.pmu.report"
    _description = "Pmu User Report"
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'pamsimas.pmu_report_transfer',
            'datas': datas,
       }
