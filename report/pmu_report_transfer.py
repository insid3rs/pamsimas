...
class pmu_report_transfer(report_sxw.rml_parse):
    
    def __init__(self, cr, uid, name, context=None):
        super(pmu_report_transfer, self).__init__(cr, uid, name, context=context)
        self.transfer=False
...
report_sxw.report_sxw('report.pamsimas.pmu_report_transfer', 
                      'pamsimas.transfer', 
                      'addons/pamsimas/report/pamsimas_pmu_report.rml', 
                      parser=pmu_report_transfer, 
                      header=False)